...
<body>
	...
	<div class="main">
		...
		<div class="right">
		<form action="/dynamic/team/month" id="teamHourForm" method="post">
			<div class="location">
            ...
            <table class="table table-striped table-bordered tables" style="margin-top:40px;width:100px;">
              ...
              <c:forEach var="team" items="${list}" varStatus="status">
                <tr>
                  ...
                  <td class="td_1_${team.teamid}">${team.month1}</td>
                  <td class="td_2_${team.teamid}">${team.month2}</td>
                  <td class="td_3_${team.teamid}">${team.month3}</td>
                  <td class="td_4_${team.teamid}">${team.month4}</td>
                  <td class="td_5_${team.teamid}">${team.month5}</td>
                  <td class="td_6_${team.teamid}">${team.month6}</td>
                  <td class="td_7_${team.teamid}">${team.month7}</td>
                  <td class="td_8_${team.teamid}">${team.month8}</td>
                  <td class="td_9_${team.teamid}">${team.month9}</td>
                  <td class="td_10_${team.teamid}">${team.month10}</td>
                  <td class="td_11_${team.teamid}">${team.month11}</td>
                  <td class="td_12_${team.teamid}">${team.month12}</td>
                </tr>
                </c:forEach>
              </tbody>
            </table>
