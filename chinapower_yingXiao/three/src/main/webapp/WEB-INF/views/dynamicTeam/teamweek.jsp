...
<body>
	...
	<div class="main">
		...
		<div class="right">
		<form action="/dynamic/team/week" id="teamHourForm" method="post">
			<div class="location">
            ...
            <table class="table table-striped table-bordered tables" style="margin-top:40px;width:100px;">
              ...
              <c:forEach var="team" items="${list}" varStatus="status">
                <tr>
                  ...
                  <td class="td_1_${team.teamid}">${team.week1}</td>
                  <td class="td_2_${team.teamid}">${team.week2}</td>
                  <td class="td_3_${team.teamid}">${team.week3}</td>
                  <td class="td_4_${team.teamid}">${team.week4}</td>
                  <td class="td_5_${team.teamid}">${team.week5}</td>
                  <td class="td_6_${team.teamid}">${team.week6}</td>
                  <td class="td_7_${team.teamid}">${team.week7}</td>
                  <td class="td_8_${team.teamid}">${team.week8}</td>
                  <td class="td_9_${team.teamid}">${team.week9}</td>
                  <td class="td_10_${team.teamid}">${team.week10}</td>
                  <td class="td_11_${team.teamid}">${team.week11}</td>
                  <td class="td_12_${team.teamid}">${team.week12}</td>
                  <td class="td_13_${team.teamid}">${team.week13}</td>
                  <td class="td_14_${team.teamid}">${team.week14}</td>
                  <td class="td_15_${team.teamid}">${team.week15}</td>
                  <td class="td_16_${team.teamid}">${team.week16}</td>
                  <td class="td_17_${team.teamid}">${team.week17}</td>
                  <td class="td_18_${team.teamid}">${team.week18}</td>
                  <td class="td_19_${team.teamid}">${team.week19}</td>
                  <td class="td_20_${team.teamid}">${team.week20}</td>
                  <td class="td_21_${team.teamid}">${team.week21}</td>
                  <td class="td_22_${team.teamid}">${team.week22}</td>
                  <td class="td_23_${team.teamid}">${team.week23}</td>
                  <td class="td_24_${team.teamid}">${team.week24}</td>
                  <td class="td_25_${team.teamid}">${team.week25}</td>
                  <td class="td_26_${team.teamid}">${team.week26}</td>
                  <td class="td_27_${team.teamid}">${team.week27}</td>
                  <td class="td_28_${team.teamid}">${team.week28}</td>
                  <td class="td_29_${team.teamid}">${team.week29}</td>
                  <td class="td_30_${team.teamid}">${team.week30}</td>
                  <td class="td_31_${team.teamid}">${team.week31}</td>
                  
                  <td class="td_32_${team.teamid}">${team.week32}</td>
                  <td class="td_33_${team.teamid}">${team.week33}</td>
                  <td class="td_34_${team.teamid}">${team.week34}</td>
                  <td class="td_35_${team.teamid}">${team.week35}</td>
                  <td class="td_36_${team.teamid}">${team.week36}</td>
                  <td class="td_37_${team.teamid}">${team.week37}</td>
                  <td class="td_38_${team.teamid}">${team.week38}</td>
                  <td class="td_39_${team.teamid}">${team.week39}</td>
                  <td class="td_40_${team.teamid}">${team.week40}</td>
                  <td class="td_41_${team.teamid}">${team.week41}</td>
                  <td class="td_42_${team.teamid}">${team.week42}</td>
                  <td class="td_43_${team.teamid}">${team.week43}</td>
                  <td class="td_44_${team.teamid}">${team.week44}</td>
                  <td class="td_45_${team.teamid}">${team.week45}</td>
                  <td class="td_46_${team.teamid}">${team.week46}</td>
                  <td class="td_47_${team.teamid}">${team.week47}</td>
                  <td class="td_48_${team.teamid}">${team.week48}</td>
                  <td class="td_49_${team.teamid}">${team.week49}</td>
                  <td class="td_50_${team.teamid}">${team.week50}</td>
                  <td class="td_51_${team.teamid}">${team.week51}</td>
                  <td class="td_52_${team.teamid}">${team.week52}</td>
                  <td class="td_53_${team.teamid}">${team.week53}</td>
                </tr>
                </c:forEach>
              </tbody>
            </table>
