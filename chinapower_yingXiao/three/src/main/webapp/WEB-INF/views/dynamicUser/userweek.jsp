...
<body>
	...
	<div class="main">
		...
		<div class="right">
		<form action="/dynamic/user/week" id="teamHourForm" method="post">
			<div class="location">
          ...
          <div class="right-content">
            ...
            <table class="table table-striped table-bordered tables" style="margin-top:40px;width:100px;">
              ...
              <c:forEach var="team" items="${list}" varStatus="status">
                <tr>
                  <td>
                  	<input type="checkbox" class="projectid" value="${team.userid}"/>
                  	${status.index +1}
                  </td>
                  <td class="td_projectname_${team.userid} projectname">${team.username}</td>
                  <td class="td_1_${team.userid}">${team.week1}</td>
                  <td class="td_2_${team.userid}">${team.week2}</td>
                  <td class="td_3_${team.userid}">${team.week3}</td>
                  <td class="td_4_${team.userid}">${team.week4}</td>
                  <td class="td_5_${team.userid}">${team.week5}</td>
                  <td class="td_6_${team.userid}">${team.week6}</td>
                  <td class="td_7_${team.userid}">${team.week7}</td>
                  <td class="td_8_${team.userid}">${team.week8}</td>
                  <td class="td_9_${team.userid}">${team.week9}</td>
                  <td class="td_10_${team.userid}">${team.week10}</td>
                  <td class="td_11_${team.userid}">${team.week11}</td>
                  <td class="td_12_${team.userid}">${team.week12}</td>
                  <td class="td_13_${team.userid}">${team.week13}</td>
                  <td class="td_14_${team.userid}">${team.week14}</td>
                  <td class="td_15_${team.userid}">${team.week15}</td>
                  <td class="td_16_${team.userid}">${team.week16}</td>
                  <td class="td_17_${team.userid}">${team.week17}</td>
                  <td class="td_18_${team.userid}">${team.week18}</td>
                  <td class="td_19_${team.userid}">${team.week19}</td>
                  <td class="td_20_${team.userid}">${team.week20}</td>
                  <td class="td_21_${team.userid}">${team.week21}</td>
                  <td class="td_22_${team.userid}">${team.week22}</td>
                  <td class="td_23_${team.userid}">${team.week23}</td>
                  <td class="td_24_${team.userid}">${team.week24}</td>
                  <td class="td_25_${team.userid}">${team.week25}</td>
                  <td class="td_26_${team.userid}">${team.week26}</td>
                  <td class="td_27_${team.userid}">${team.week27}</td>
                  <td class="td_28_${team.userid}">${team.week28}</td>
                  <td class="td_29_${team.userid}">${team.week29}</td>
                  <td class="td_30_${team.userid}">${team.week30}</td>
                  <td class="td_31_${team.userid}">${team.week31}</td>
                  
                  <td class="td_32_${team.userid}">${team.week32}</td>
                  <td class="td_33_${team.userid}">${team.week33}</td>
                  <td class="td_34_${team.userid}">${team.week34}</td>
                  <td class="td_35_${team.userid}">${team.week35}</td>
                  <td class="td_36_${team.userid}">${team.week36}</td>
                  <td class="td_37_${team.userid}">${team.week37}</td>
                  <td class="td_38_${team.userid}">${team.week38}</td>
                  <td class="td_39_${team.userid}">${team.week39}</td>
                  <td class="td_40_${team.userid}">${team.week40}</td>
                  <td class="td_41_${team.userid}">${team.week41}</td>
                  <td class="td_42_${team.userid}">${team.week42}</td>
                  <td class="td_43_${team.userid}">${team.week43}</td>
                  <td class="td_44_${team.userid}">${team.week44}</td>
                  <td class="td_45_${team.userid}">${team.week45}</td>
                  <td class="td_46_${team.userid}">${team.week46}</td>
                  <td class="td_47_${team.userid}">${team.week47}</td>
                  <td class="td_48_${team.userid}">${team.week48}</td>
                  <td class="td_49_${team.userid}">${team.week49}</td>
                  <td class="td_50_${team.userid}">${team.week50}</td>
                  <td class="td_51_${team.userid}">${team.week51}</td>
                  <td class="td_52_${team.userid}">${team.week52}</td>
                  <td class="td_53_${team.userid}">${team.week53}</td>
                </tr>
                </c:forEach>
              </tbody>
            </table>
	...
	$("#${viewType}").addClass("typeColor");
	      ...
	      if(null!=error && ""!=error){
			...
			function submitForm(){
		    	...
		    	beforeCommit();
				$("#teamHourForm").attr("action","dynamic/user/"+$("#classType").val()).submit();
			}
			function query(){
				beforeCommit();
				$("#teamHourForm").attr("action","dynamic/user/"+$("#classType").val()).submit();
