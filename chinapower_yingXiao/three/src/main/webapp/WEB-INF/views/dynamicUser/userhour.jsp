...
<body>
	...
	<div class="main">
		...
		<div class="right">
		<form action="/dynamic/user/hour" id="projectHourForm" method="post">
			<div class="location">
            ...
            <table class="table table-striped table-bordered tables" style="margin-top:40px;width:100px;">
              ...
              <c:forEach var="project" items="${list}" varStatus="status">
                <tr>
                  ...
                  <td class="td_0_${project.userid}">${project.hour0}</td>
                  <td class="td_1_${project.userid}">${project.hour1}</td>
                  <td class="td_2_${project.userid}">${project.hour2}</td>
                  <td class="td_3_${project.userid}">${project.hour3}</td>
                  <td class="td_4_${project.userid}">${project.hour4}</td>
                  <td class="td_5_${project.userid}">${project.hour5}</td>
                  <td class="td_6_${project.userid}">${project.hour6}</td>
                  <td class="td_7_${project.userid}">${project.hour7}</td>
                  <td class="td_8_${project.userid}">${project.hour8}</td>
                  <td class="td_9_${project.userid}">${project.hour9}</td>
                  <td class="td_10_${project.userid}">${project.hour10}</td>
                  <td class="td_11_${project.userid}">${project.hour11}</td>
                  <td class="td_12_${project.userid}">${project.hour12}</td>
                  <td class="td_13_${project.userid}">${project.hour13}</td>
                  <td class="td_14_${project.userid}">${project.hour14}</td>
                  <td class="td_15_${project.userid}">${project.hour15}</td>
                  <td class="td_16_${project.userid}">${project.hour16}</td>
                  <td class="td_17_${project.userid}">${project.hour17}</td>
                  <td class="td_18_${project.userid}">${project.hour18}</td>
                  <td class="td_19_${project.userid}">${project.hour19}</td>
                  <td class="td_20_${project.userid}">${project.hour20}</td>
                  <td class="td_21_${project.userid}">${project.hour21}</td>
                  <td class="td_22_${project.userid}">${project.hour22}</td>
                  <td class="td_23_${project.userid}">${project.hour23}</td>
                </tr>
                </c:forEach>
              </tbody>
            </table>
	...
	$("#${viewType}").addClass("typeColor");
	      ...
	      if(null!=error && ""!=error){
			...
			function submitForm(){
		    	...
		    	beforeCommit();
				//$("#projectHourForm").attr("action","dynamic/user/hour").submit();
