...
<body>
	...
	<div class="main">
		...
		<div class="right">
		<form action="/dynamic/project/hour" id="projectHourForm" method="post">
			<div class="location">
            ...
            <table class="table table-striped table-bordered tables" style="margin-top:40px;width:100px;">
              ...
              <c:forEach var="project" items="${list}" varStatus="status">
                <tr>
                  ...
                  <td class="td_0_${project.projectid}">${project.hour0}</td>
                  <td class="td_1_${project.projectid}">${project.hour1}</td>
                  <td class="td_2_${project.projectid}">${project.hour2}</td>
                  <td class="td_3_${project.projectid}">${project.hour3}</td>
                  <td class="td_4_${project.projectid}">${project.hour4}</td>
                  <td class="td_5_${project.projectid}">${project.hour5}</td>
                  <td class="td_6_${project.projectid}">${project.hour6}</td>
                  <td class="td_7_${project.projectid}">${project.hour7}</td>
                  <td class="td_8_${project.projectid}">${project.hour8}</td>
                  <td class="td_9_${project.projectid}">${project.hour9}</td>
                  <td class="td_10_${project.projectid}">${project.hour10}</td>
                  <td class="td_11_${project.projectid}">${project.hour11}</td>
                  <td class="td_12_${project.projectid}">${project.hour12}</td>
                  <td class="td_13_${project.projectid}">${project.hour13}</td>
                  <td class="td_14_${project.projectid}">${project.hour14}</td>
                  <td class="td_15_${project.projectid}">${project.hour15}</td>
                  <td class="td_16_${project.projectid}">${project.hour16}</td>
                  <td class="td_17_${project.projectid}">${project.hour17}</td>
                  <td class="td_18_${project.projectid}">${project.hour18}</td>
                  <td class="td_19_${project.projectid}">${project.hour19}</td>
                  <td class="td_20_${project.projectid}">${project.hour20}</td>
                  <td class="td_21_${project.projectid}">${project.hour21}</td>
                  <td class="td_22_${project.projectid}">${project.hour22}</td>
                  <td class="td_23_${project.projectid}">${project.hour23}</td>
                </tr>
                </c:forEach>
              </tbody>
            </table>
	...
	$("#${viewType}").addClass("typeColor");
	      ...
	      if(null!=error && ""!=error){
			...
			function submitForm(){
		    	...
		    	beforeCommit();
				//$("#projectHourForm").attr("action","dynamic/project/hour").submit();
