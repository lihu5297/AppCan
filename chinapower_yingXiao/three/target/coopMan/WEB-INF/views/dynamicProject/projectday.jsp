...
<body>
	...
	<div class="main">
		...
		<div class="right">
		<form action="/dynamic/project/day" id="projectHourForm" method="post">
			<div class="location">
          ...
          <div class="right-content">
            ...
            <table class="table table-striped table-bordered tables" style="margin-top:40px;width:100px;">
              ...
              <c:forEach var="project" items="${list}" varStatus="status">
                <tr>
                  <td>
                  	<input type="checkbox" class="projectid" value="${project.projectid}"/>
                  	${status.index +1}
                  </td>
                  <td class="td_projectname_${project.projectid} projectname">${project.projectname}</td>
                  <td class="td_1_${project.projectid}">${project.day1}</td>
                  <td class="td_2_${project.projectid}">${project.day2}</td>
                  <td class="td_3_${project.projectid}">${project.day3}</td>
                  <td class="td_4_${project.projectid}">${project.day4}</td>
                  <td class="td_5_${project.projectid}">${project.day5}</td>
                  <td class="td_6_${project.projectid}">${project.day6}</td>
                  <td class="td_7_${project.projectid}">${project.day7}</td>
                  <td class="td_8_${project.projectid}">${project.day8}</td>
                  <td class="td_9_${project.projectid}">${project.day9}</td>
                  <td class="td_10_${project.projectid}">${project.day10}</td>
                  <td class="td_11_${project.projectid}">${project.day11}</td>
                  <td class="td_12_${project.projectid}">${project.day12}</td>
                  <td class="td_13_${project.projectid}">${project.day13}</td>
                  <td class="td_14_${project.projectid}">${project.day14}</td>
                  <td class="td_15_${project.projectid}">${project.day15}</td>
                  <td class="td_16_${project.projectid}">${project.day16}</td>
                  <td class="td_17_${project.projectid}">${project.day17}</td>
                  <td class="td_18_${project.projectid}">${project.day18}</td>
                  <td class="td_19_${project.projectid}">${project.day19}</td>
                  <td class="td_20_${project.projectid}">${project.day20}</td>
                  <td class="td_21_${project.projectid}">${project.day21}</td>
                  <td class="td_22_${project.projectid}">${project.day22}</td>
                  <td class="td_23_${project.projectid}">${project.day23}</td>
                  <td class="td_24_${project.projectid}">${project.day24}</td>
                  <td class="td_25_${project.projectid}">${project.day25}</td>
                  <td class="td_26_${project.projectid}">${project.day26}</td>
                  <td class="td_27_${project.projectid}">${project.day27}</td>
                  <td class="td_28_${project.projectid}">${project.day28}</td>
                  <td class="td_29_${project.projectid}">${project.day29}</td>
                  <td class="td_30_${project.projectid}">${project.day30}</td>
                  <td class="td_31_${project.projectid}">${project.day31}</td>
                </tr>
                </c:forEach>
              </tbody>
            </table>
	...
	$("#${viewType}").addClass("typeColor");
	      ...
	      if(null!=error && ""!=error){
			...
			function submitForm(){
		    	...
		    	beforeCommit();
				//$("#projectHourForm").attr("action","dynamic/project/day").submit();
		    	$("#projectHourForm").attr("action","dynamic/project/"+$("#classType").val()).submit();
			}
			function query(){
				beforeCommit();
				//$("#projectHourForm").attr("action","dynamic/project/day").submit();
