...
<body>
	...
	<div class="main">
		...
		<div class="right">
		<form action="/dynamic/team/day" id="teamHourForm" method="post">
			<div class="location">
            ...
            <table class="table table-striped table-bordered tables" style="margin-top:40px;width:100px;">
              ...
              <c:forEach var="team" items="${list}" varStatus="status">
                <tr>
                  ...
                  <td class="td_1_${team.teamid}">${team.day1}</td>
                  <td class="td_2_${team.teamid}">${team.day2}</td>
                  <td class="td_3_${team.teamid}">${team.day3}</td>
                  <td class="td_4_${team.teamid}">${team.day4}</td>
                  <td class="td_5_${team.teamid}">${team.day5}</td>
                  <td class="td_6_${team.teamid}">${team.day6}</td>
                  <td class="td_7_${team.teamid}">${team.day7}</td>
                  <td class="td_8_${team.teamid}">${team.day8}</td>
                  <td class="td_9_${team.teamid}">${team.day9}</td>
                  <td class="td_10_${team.teamid}">${team.day10}</td>
                  <td class="td_11_${team.teamid}">${team.day11}</td>
                  <td class="td_12_${team.teamid}">${team.day12}</td>
                  <td class="td_13_${team.teamid}">${team.day13}</td>
                  <td class="td_14_${team.teamid}">${team.day14}</td>
                  <td class="td_15_${team.teamid}">${team.day15}</td>
                  <td class="td_16_${team.teamid}">${team.day16}</td>
                  <td class="td_17_${team.teamid}">${team.day17}</td>
                  <td class="td_18_${team.teamid}">${team.day18}</td>
                  <td class="td_19_${team.teamid}">${team.day19}</td>
                  <td class="td_20_${team.teamid}">${team.day20}</td>
                  <td class="td_21_${team.teamid}">${team.day21}</td>
                  <td class="td_22_${team.teamid}">${team.day22}</td>
                  <td class="td_23_${team.teamid}">${team.day23}</td>
                  <td class="td_24_${team.teamid}">${team.day24}</td>
                  <td class="td_25_${team.teamid}">${team.day25}</td>
                  <td class="td_26_${team.teamid}">${team.day26}</td>
                  <td class="td_27_${team.teamid}">${team.day27}</td>
                  <td class="td_28_${team.teamid}">${team.day28}</td>
                  <td class="td_29_${team.teamid}">${team.day29}</td>
                  <td class="td_30_${team.teamid}">${team.day30}</td>
                  <td class="td_31_${team.teamid}">${team.day31}</td>
                </tr>
                </c:forEach>
              </tbody>
            </table>
