...
<body>
	...
	<div class="main">
		...
		<div class="right">
		<form action="/dynamic/user/month" id="teamHourForm" method="post">
			<div class="location">
            ...
            <table class="table table-striped table-bordered tables" style="margin-top:40px;width:100px;">
              ...
              <c:forEach var="team" items="${list}" varStatus="status">
                <tr>
                  ...
                  <td class="td_1_${team.userid}">${team.month1}</td>
                  <td class="td_2_${team.userid}">${team.month2}</td>
                  <td class="td_3_${team.userid}">${team.month3}</td>
                  <td class="td_4_${team.userid}">${team.month4}</td>
                  <td class="td_5_${team.userid}">${team.month5}</td>
                  <td class="td_6_${team.userid}">${team.month6}</td>
                  <td class="td_7_${team.userid}">${team.month7}</td>
                  <td class="td_8_${team.userid}">${team.month8}</td>
                  <td class="td_9_${team.userid}">${team.month9}</td>
                  <td class="td_10_${team.userid}">${team.month10}</td>
                  <td class="td_11_${team.userid}">${team.month11}</td>
                  <td class="td_12_${team.userid}">${team.month12}</td>
                </tr>
                </c:forEach>
              </tbody>
            </table>
